...
namespace FairlyInspection.Utility
{
    ...
    {
        public static string POP3Host= ConfigurationManager.AppSettings["POP3Host"];
        public static string POP3Acc= ConfigurationManager.AppSettings["POP3Acc"];
        public static string POP3Pwd = ConfigurationManager.AppSettings["POP3Pwd"];
        public static int POP3Port = Convert.ToInt32(ConfigurationManager.AppSettings["POP3Port"]);
        ...
        public static void POP3Mail(string to, string subject, string body, MemoryStream ms = null)
        {
            try
            {
                ...
                if (ms != null)
                {
                    ...
                    System.Net.Mail.Attachment attachment = new System.Net.Mail.Attachment(ms, "會議邀請.ics", "text/calendar");
